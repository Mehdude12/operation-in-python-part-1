...
math = int(input("Plese enter maths marks:"))
hindi = int(input("Plese enter hindi marks:"))
science = int(input("Plese enter science marks:"))
english = int(input("Plese enter english marks:"))
sum = math + hindi + science + english
print(sum)
perc = (sum/400)*100
print(perc)
